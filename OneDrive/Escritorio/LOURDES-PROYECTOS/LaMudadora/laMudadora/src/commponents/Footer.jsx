...
// Importa íconos de lucide-react (asume que los tienes instalados)
// Si no los tienes, puedes usar <i className="fas fa-icon"></i> o quitarlos.
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8 border-b border-gray-700 pb-10">
                    ...
                    <div>
                        ...
                        <div className="flex flex-col space-y-3">
                            ...
                            <FooterLink href="#precios">Trabaja con Nosotros</FooterLink>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="flex flex-col space-y-4 text-gray-400">
                            ...
                            <div className="flex items-center">
                                ...
                                <span className="text-sm md:text-base">contacto@mudanza.com</span>
                            </div>
