...
function HeroSection() {
    ...
    const HERO_IMAGE_URL = "https://placehold.co/500x400/93C5FD/1E3A8A?text=Camión+de+La+Mudadora"; // bg-blue-300
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="lg:grid lg:grid-cols-2 lg:gap-x-12 xl:gap-x-16 items-center">
                    ...
                    <div className="mt-12 lg:mt-0 relative flex justify-center lg:justify-end">
                        <div className="relative w-full max-w-md h-96 sm:h-[450px]">
                            ...
                            <div className="absolute inset-0 bg-blue-100 rounded-bl-3xl sm:rounded-bl-[5rem] overflow-hidden shadow-2xl">
                                <img
                                    src={HERO_IMAGE_URL}
                                    alt="Camión de mudanzas de La Mudadora"
                                    className="w-full h-full object-cover object-center transform -translate-x-1/2" // Ajuste para mover la imagen a la derecha del contenedor con curva
