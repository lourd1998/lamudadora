...
// SVG de Tilde (Check Mark) en línea, para reemplazar Heroicons y evitar errores de compilación
...
const localServices = [
    {
        ...
        features: [
            ...
            { name: 'Garantia y embalaje del mobiliario' },
        ],
        imageUrl: 'https://placehold.co/1024x600/FDBA74/9D5C0D?text=Servicio+Estandar+Carga',
        imageSide: 'left', // Imagen a la izquierda (por defecto)
    },
    {
        name: 'Mudanza Estándar+',
        ...
        features: [
            ...
            { name: 'Embalaje de articulos fragiles, ropa, libros y +' },
            { name: 'Garantia en todo lo emabalado' },
        ],
        // FIX: Se cambió el color del placeholder a gris claro (F5F5F5) para asegurar el contraste de lectura.
        imageUrl: 'https://placehold.co/1024x600/F5F5F5/333333?text=Estandar+con+Embalaje', 
        imageSide: 'left', // <--- CAMBIO AQUÍ: Ahora la imagen va a la IZQUIERDA (Texto a la Izquierda, Imagen a la Derecha)
    },
    {
        ...
        features: [
            ...
            { name: 'Garantia en todo el servicio' },
        ],
        imageUrl: 'https://placehold.co/1024x600/C02B0F/FFFFFF?text=Servicio+Premium+Total',
        imageSide: 'left', // Imagen a la izquierda
    },
];
          ...
          {localServices.map((service, index) => (
            <div
              ...
              className={`mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-center ${
                service.imageSide === 'right' ? 'lg:grid-cols-2' : '' // Define la estructura de 2 columnas
              }`}
            >
              
              {/* Columna de Texto/Características (Cambia de orden si la imagen está a la derecha) */}
              <div 
