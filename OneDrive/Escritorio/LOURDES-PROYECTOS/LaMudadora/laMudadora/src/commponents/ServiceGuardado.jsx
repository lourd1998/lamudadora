    ...
    const services = [
        {
            ...
            imageSrc: [
                "https://placehold.co/1000x700/FF7043/ffffff?text=Baulera+Interior", // Imagen 1 (arriba)
                "https://placehold.co/1000x700/FF5722/ffffff?text=Baulera+Exterior"  // Imagen 2 (abajo)
            ],
        ...
        },
        {
            ...
            // Ahora usamos dos URLs de imagen por servicio
            imageSrc: [
                "https://placehold.co/1000x700/F57C00/ffffff?text=Muebles+Sectorizado", // Imagen 1 (arriba)
                "https://placehold.co/1000x700/FB8C00/ffffff?text=Deposito+Comun"     // Imagen 2 (abajo)
            ],
